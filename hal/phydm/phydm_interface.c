...
void odm_set_mac_reg(struct PHY_DM_STRUCT *p_dm, u32 reg_addr, u32 bit_mask, u32 data)
{
#if (DM_ODM_SUPPORT_TYPE & ODM_CE) && defined(DM_ODM_CE_MAC80211)
	struct rtl_priv *rtlpriv = (struct rtl_priv *)p_dm->adapter;
...
void odm_set_bb_reg(struct PHY_DM_STRUCT *p_dm, u32 reg_addr, u32 bit_mask, u32 data)
{
#if (DM_ODM_SUPPORT_TYPE & ODM_CE) && defined(DM_ODM_CE_MAC80211)
	struct rtl_priv *rtlpriv = (struct rtl_priv *)p_dm->adapter;
	rtl_set_bbreg(rtlpriv->hw, reg_addr, bit_mask, data);
...
void
odm_set_rf_reg(struct PHY_DM_STRUCT *p_dm, u8 e_rf_path, u32 reg_addr, u32 bit_mask, u32 data)
{
#if (DM_ODM_SUPPORT_TYPE & ODM_CE) && defined(DM_ODM_CE_MAC80211)
	struct rtl_priv *rtlpriv = (struct rtl_priv *)p_dm->adapter;
...
u32 odm_get_rf_reg(struct PHY_DM_STRUCT *p_dm, u8 e_rf_path, u32 reg_addr, u32 bit_mask)
{
#if (DM_ODM_SUPPORT_TYPE & ODM_CE) && defined(DM_ODM_CE_MAC80211)
	struct rtl_priv *rtlpriv = (struct rtl_priv *)p_dm->adapter;
